export default function SimpleArrays() {
  ...
  const functionScoped = 2; // var functionScoped = 2;
  const blockScoped = 5;  // let blockScoped = 2;
  const constant1 = functionScoped - blockScoped;
  const numberArray1 = [1, 2, 3, 4, 5];
  const stringArray1 = ["string1", "string2"];
  const htmlArray1 = [<li key="buy-milk">Buy milk</li>, <li key="feed-pets">Feed the pets</li>];
