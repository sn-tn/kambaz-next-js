...
export default function WorkingWithArrays() {
  ...
  return (
    <div id="wd-working-with-arrays">
      ...
      <hr />
      <h4>Retrieving an Item from an Array ID</h4>
      ...
      <FormControl defaultValue={todo.id} className="w-25 float-start me-2"
        onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
      <FormControl defaultValue={todo.title} className="w-50 float-start me-2"
      ...
      <div className="form-check form-switch">
        <input type="checkbox" defaultChecked={todo.completed} className="form-check-input float-end me-2"
