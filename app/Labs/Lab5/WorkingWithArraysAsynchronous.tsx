...
export default function WorkingWithArraysAsynchronously() {
  ...
  return (
    <div id="wd-asynchronous-arrays">
      <h3>Working with Arrays Asynchronous</h3>
      {errorMessage && (
      ...
      <h4>Todos
        <FaCirclePlus onClick={createNewTodo} className="text-success float-end fs-3" />
        <FaCirclePlus onClick={postNewTodo} className="text-primary float-end fs-3 me-3" />
      </h4>
      <ListGroup>
        {todos.map((todo) => (
          <ListGroupItem key={todo.id}>
            <FaTrash onClick={() => removeTodos(todo)} className="text-danger float-end mt-1" id="wd-remove-todo" />
